<?php
define('APIKEY', 'AIzaSyC4a_vjepaxFUxaWpa8kTyeBixK2BHcLyM');
define('GJ_CODE', 'JP');
define('SITE_NAME', 'ybv4k');
define('TITLENAME', 'ybv4k');
define('EN2DEKEY', 'hello123456789');
define('EMAIL', '1604012921@qq.com');
define('NAME', 'admin');
